...
#     print(SemanticChunkerProcess.semantic_chunking_process([extract_data.text_from_pdf(file_path='/home/nhatthuong/Documents/Thesis/Acne-detection-and-treatment-recommendations/backend/elasticdb/doctor_advice/storage/acne_treatment_2.pdf')]))